...
import 'package:eltohamyecommercedeliveryapp/view/widget/orders/orderDetails/customOrderDetailsTable.dart';
                    ...
                    child: Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          // ignore: prefer_interpolation_to_compose_strings
                          controller.ordersModel.addressName != null
                              ? CustomOrderTextItem("Shipping Address : " +
                                  controller.ordersModel.addressName!)
                              : const SizedBox(
                                  height: 0,
                                ),
                          controller.ordersModel.ordersRating != 0
                              ? CustomOrderTextItem("Your Order Rating: " +
