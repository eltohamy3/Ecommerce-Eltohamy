...
import 'package:eltohamyecommercedeliveryapp/view/widget/auth/verifycode/customResendcode.dart';
import 'package:eltohamyecommercedeliveryapp/view/widget/auth/verifycode/customVerificaitonCodeForm.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';
import 'package:get/get.dart';

class VerificaitonCode extends StatelessWidget {
  const VerificaitonCode({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<VerifyCodeControllerImp> (builder: (controller) =>  Container(
        padding: const EdgeInsets.symmetric(vertical: 15, horizontal: 30),
        child:  HanddlingDataViewRequest(
                  statusRequest: controller.statusRequest,
                  widget:ListView(
          children: [
            const CustomTextTitleAuth(texttitle: "Check verificaiton Code"),
            const SizedBox(
              height: 20,
            ),
            const CustomTextsubtitleAuth(
              subtitle: 'Enter your code to to continue to reaset your password ',
            ),
            const SizedBox(
              height: 40,
            ),
            ...
            CustomButtonAuth(
              ...
              onPressed: () =>  controller.CodeVerify(),
            ),
            const SizedBox(
              height: 30,
            ),
