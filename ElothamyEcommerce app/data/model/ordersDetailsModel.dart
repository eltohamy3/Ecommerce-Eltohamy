class OrdersDetailsModel {
  ...
  OrdersDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    productPriceOnOrder = 1.0 * json['productPriceOnOrder'];
    numberOfItems = json['NumberOfItems'];
    priceOfItems =1.0 * json['PriceOfItems'];
    ...
    itemsPrice = 1.0 *json['items_price'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['productPriceOnOrder'] = this.productPriceOnOrder;
    data['NumberOfItems'] = this.numberOfItems;
    data['PriceOfItems'] = this.priceOfItems;
