...
class CustomEditItemsForm extends GetView<EditItemsControllerImp> {
  const CustomEditItemsForm({super.key});
        ...
        child: Column(
          children: [
            ...
            CustomTextFormAuth(
                ...
                validator: (val) => CheckEmpty(val)),
                RadioListTile(
                  selected: controller.itemsActive == "0",
                ...
                RadioListTile(
                  selected: controller.itemsActive == "1",
